...
DEFAULT_PRODUCTS = {
    ...
    "p2": {"name": "Myntra 100 Off on 499", "price": 20, "file": str(DATA_DIR / "myntra100on499.txt"), "reserve": 2},
    "p3": {
        "name": "Myntra Combo(100+100)",
        "price": 50,
        "combo_files": [str(DATA_DIR / "myntra100on199.txt"), str(DATA_DIR / "myntra100on499.txt")],
        "reserve": 2,
    },
